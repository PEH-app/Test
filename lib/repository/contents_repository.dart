...
//댓글코드 - 실패
  // Future<dynamic> loadContentsFromLocation(
  //     //사실 비동기코드는 무의미해서 수정 필요
  //     String location) async {
  //   //API 통신 location 값을 보내주면서
  //   await Future.delayed(Duration(milliseconds: 1000));
  ...
  // String loadContentsFromLocation(String location) {
  //   return data[location];
  // }

  List<Map<String, String>> loadContentsFromLocation(String location) {
    // Future 제거하고 data를 List<Map<String, String>>으로 캐스팅하여 반환
    return List<Map<String, String>>.from(data[location]);
  }
}
